...
/**
 * Thin proxy to the NASNET Intelligence Layer (nasnet-intel).
 *
 * In Docker: fetches from http://nasnet-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[NASNET] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
